        ...
        Card(
            ...
            Column(modifier = Modifier.padding(10.dp)) {
                Row(
                    ...
                    Text(
                        text = "${"%.1f".format(confidencePct)}%  (Threshold >= 74%)",
                        fontSize = 11.sp,
                        fontWeight = FontWeight.Bold,
                        color = if (confidencePct >= 74f) Color(0xFF00E676) else Color(0xFFFFD600)
                    )
                }
                ...
                LinearProgressIndicator(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(8.dp),
                    color = if (confidencePct >= 74f) Color(0xFF00E676) else if (confidencePct >= 50f) Color(0xFFFFD600) else Color(0xFFFF5252),
